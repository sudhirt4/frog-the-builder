...
(function () {
  ...
  var playState = {
    create: function () {
      ...
      this.scoreText = game.add.text(100, 50, '0', {
        fill: '#333',
        font: '30px Simpsons'
      });
    ...
    fall: function () {
      if (!this.fallActive && this.gameStatus) {
  ...
  var gameOverState = {
    create: function () {
      ...
      if(this.newHighScore) {
        var title = game.add.text(game.world.centerX, game.world.height / 8, "New Highscore", {
          fill: 'yellow',
          font: 'Simpsons',
          fontSize: 20
        });
      ...
      var title = game.add.text(game.world.centerX, game.world.height / 4, "Game Over", {
        fill: '#fff',
        font: 'Simpsons',
        fontSize: 48
      });
      ...
      game.add.text(game.world.centerX, game.world.centerY - 50, score, {
        fill: '#fff',
        font: '30px Simpsons',
        fontSize: 50
      }).anchor.setTo(0.5, 0.5);
      ...
      var btn = game.add.text(game.world.centerX,
      (game.world.height / 2) + 2 * (game.world.height / 9),
      'Highscore', {fill: '#333', font: '18px Simpsons'});
      btn.anchor.setTo(0.5, 0.5);
      btn.inputEnabled = true;
      btn.events.onInputDown.add(function () {
    ...
    preload: function () {
      ...
      if(score > highScore.score) {
        ...
        highScore.google_name = document.getElementById('google_name').value;
        $('#score').val(score);
        submitScore();
      }
    }
  ...
  var highScoreState = {
    create: function () {
      ...
      var title = game.add.text(game.world.centerX, game.world.height / 2.4, "Highscore", {
        fill: '#fff',
        font: 'Simpsons',
        fontSize: 20
      });
      ...
      game.add.text(game.world.centerX, game.world.height /1.6, highScore.google_name , {
        fill: '#fff',
        font: '30px Simpsons',
        fontSize: 18
      }).anchor.setTo(0.5, 0.5);

      game.add.text(game.world.centerX, game.world.height / 1.9, highScore.score , {
        fill: '#fff',
        font: '30px Simpsons',
        fontSize: 48
      }).anchor.setTo(0.5, 0.5);
